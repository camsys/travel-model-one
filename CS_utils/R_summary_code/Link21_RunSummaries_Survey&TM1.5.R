...
model_run_weight_r = get_model_weight(output_rdata_dir, out_stops_r)

skim_dir_r = file.path(model_data_dir, 'database')
skim_Dist_AM_r = 'DistanceSkimsDatabaseAM.csv'
skim_Time_AM_r = 'TimeSkimsDatabaseAM.csv'
skim_Dist_OP_r = 'DistanceSkimsDatabaseEA.csv'
skim_Time_OP_r = 'TimeSkimsDatabaseEA.csv'
