...
read_files <- function() {
  ...
  # right side skim
  setwd(skim_dir_r)
  Dist_AM_r <- fread(skim_Dist_AM_r)
  Time_AM_r <- fread(skim_Time_AM_r)
  Dist_OP_r <- fread(skim_Dist_OP_r)
  Time_OP_r <- fread(skim_Time_OP_r)
  temp_rt = skim_process_csv(Dist_AM_r, Time_AM_r, Dist_OP_r, Time_OP_r)
