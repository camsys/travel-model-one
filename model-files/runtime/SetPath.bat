...
set JAVA_PATH=C:\Program Files\Java\jre1.8.0_333

:: The location of the GAWK binary executable files
set GAWK_PATH=C:\Program Files (x86)\GnuWin32

:: The location of R and R libraries
set R_HOME=C:\Program Files\R\R-4.2.1
set R_LIB=C:/Program Files/R/R-4.2.1/library
