...
def config_distribution(replacements):
    ...
    elif hostname in ['MODEL2-A','MODEL2-B','MODEL2-C','MODEL2-D','PORMDLPPW01','PORMDLPPW02', 'LINK21-WRK1'] or hostname.startswith("WIN-"):
...
def config_distribution(replacements):
    ...
    elif hostname in ['MODEL2-A','MODEL2-B','MODEL2-C','MODEL2-D','PORMDLPPW01','PORMDLPPW02', 'AUSCWS01','DENCWS01','LINK21-WRK1'] or hostname.startswith("WIN-"):
        # accessibilities: 48 logical processors
        filepath = os.path.join("CTRAMP","runtime","accessibilities.properties")
        replacements[filepath]["(\nnum.acc.threads[ \t]*=[ \t]*)(\S*)"] = r"\g<1>48"
